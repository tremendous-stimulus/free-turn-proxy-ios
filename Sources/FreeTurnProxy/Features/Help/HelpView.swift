...
struct HelpView: View {
    ...
    private let faq: [(q: String, a: String)] = [
        ...
        ("Я подключился через вкладку «Конфигурации», но зарубежные сервисы всё еще блокируются. Что делать?",
         "Это приложение — не VPN. Подключение через вкладку «Конфигурации» само по себе ничего не разблокирует, а лишь позволяет установить соединение с сервером, на котором работает VPN. Для того, чтобы разблокировать сервисы, нужно подключиться к этому VPN, предварительно настроив его — откройте нужную конфигурацию в списке, раздел «VPN подключение»."),
        ("С чего начать?",
         "1. Вкладка «Конфигурации»: сгенерируйте или вставьте ссылку на VK-звонок, загрузите файл конфигурации либо настройте подключение вручную через кнопку «+».\n2. Откройте добавленную конфигурацию в списке, раздел «VPN подключение»: отсканируйте QR-код с конфигурацией вашего VPN-сервера и откройте готовый файл в AmneziaWG/WireGuard через кнопку «Поделиться» (либо сохраните файл и импортируйте его вручную).\n3. Включите подключение к новому конфигу в AmneziaWG/WireGuard."),
        ("VPN не работает или перестал работать",
         "Проверьте: вверху вкладки «Конфигурации» горит зелёная точка; адрес сервера и ключ введены без ошибок; подключение в AmneziaWG/WireGuard включено; на телефоне есть обычный интернет. Если всё верно — попробуйте всё выключить и включить заново. Если это не помогло — напишите в поддержку."),
        ("Нужно ли держать приложение открытым?",
         "После того как во вкладке «Конфигурации» высветилось «Подключено», приложение можно свернуть"),
